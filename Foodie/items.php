    ...
    ?>
        <table class="table">
            ...
            <tr class="quesRow" scope="row">
                ...
                <th>
                    <label class="studName">Description</label>
                </th>
                <th>
                    <label class="studName">Price</label>
                </th>
                <th>
                ...
                <form action="items.php" method="GET">
                    <td>
                        <div class="countainer">
                            <input name="itemName" class="additem form-control" type="text" required>
                        </div>
                    </td>
                    <td>
                        <div class="countainer">
                            <input name="description" class="additem form-control" type="text" >
                        </div>
                    </td>
                    <td>
                        <div class="countainer">
                            <input name="price" class="additem form-control" type="number" required>
                        </div>
                    </td>
                    <td>
                        <div class="countainer">
                    ...
                    <td>
                        <input type="hidden" name="cat"value="<?php echo $cat ?>">
                            <button type="submit" name="submit" class="orderBtn reserveBtn btn "> Add item</button>
                    </td>
                </form 
            </tr>
            <?php
